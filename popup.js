...
function updateCountdown() {
  const timeValue = $("timeInput").value || "08:00:00";
  ...
  if (hours > 0) {
    ...
    $("countdown").textContent = `⏳ ${minutes}m ${seconds}s remaining`;
  } else {
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  $("timeInput").value = settings.time || "08:00:00";
